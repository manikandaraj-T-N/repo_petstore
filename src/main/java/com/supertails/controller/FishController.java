...
public class FishController {
    ...
    public String fishFood(
        ...
        List<Product> products = productRepository.findAll().stream()
            .filter(p -> p.getPetType() != null && p.getPetType().contains("Fish"))
        ...
        petTypeCountMap.put("Turtle", products.stream()
            .filter(p -> p.getPetType() != null && p.getPetType().contains("Turtle"))
            .count());
